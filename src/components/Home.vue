<template>
	<div style="height:100%">
		...
		<swiper :list="barders" dots-position="center" auto loop :show-desc-mask="false" :aspect-ratio="220/414"/>
		<div style="height:44px">
			<sticky scroll-box="vux_view_box_body" :offset="46">
				<tab :line-width="2" active-color="#ff6f06" bar-active-color="#ff6f06" custom-bar-width="45px">
					<tab-item v-for="item in tabList" :key="item">{{ item }}</tab-item>
				</tab>
			</sticky>
		</div>
		<product-list :loading-show="loadingShow" :list="list"/>
